  ...
  return (
    <div className="flex h-screen" style={{ backgroundColor: '#F1F1F1' }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative" style={{
        ...
        backgroundImage: "url('https://images.unsplash.com/photo-1462331940025-496dfbfc7564?q=80&w=1200')",
        backgroundSize: 'cover',
        backgroundPosition: 'center'
      }}>
        <div className="absolute inset-0" style={{ backgroundColor: 'rgba(33, 32, 156, 0.7)' }}></div>
        ...
        <div className="absolute bottom-24 left-8 right-8 text-white z-10">
          <h1 className="text-4xl font-bold mb-4">
            Discover the <span style={{ color: '#FDB827' }}>wonders</span><br />
            of the cosmos
          </h1>
          <p className="mb-6 text-lg">Join our community of space enthusiasts and embark on a journey through the universe.</p>
          <div className="flex items-center">
            <div className="h-1 w-10 bg-yellow-500 mr-4" style={{ backgroundColor: '#FDB827' }}></div>
            <span className="text-sm">Over 10,000 explorers already joined</span>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="max-w-md w-full">
          <h2 className="text-3xl font-bold mb-2" style={{ color: '#23120B' }}>Welcome back</h2>
          <p className="mb-8" style={{ color: '#23120B' }}>Continue your cosmic journey with ExploreMe</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block mb-2 text-sm font-medium" style={{ color: '#23120B' }}>
                Email Address
              </label>
              <input
                type="email"
          ...
          <div className="mt-6 text-center">
            ...
            <div className="mt-4">
              <button className="w-full py-3 border rounded-md flex items-center justify-center" style={{ borderColor: '#21209C' }}>
